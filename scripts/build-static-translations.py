...
UI = {
    "en": {
        ...
        "wifiConnectSubtitle": "Tap to copy the password",
        "wifiConnectHint": "<strong>Password copied.</strong> Open <strong>Settings → Wi‑Fi</strong>, select “{ssid}”, and <strong>paste</strong>.",
        "wifiConnectHintOpen": "Connect to “{ssid}” from your phone settings. No password required.",
    },
    "fr": {
        ...
        "wifiConnectSubtitle": "Appuyez pour copier le mot de passe",
        ...
        "wifiConnectHintOpen": "Connectez-vous au réseau « {ssid} » depuis les réglages de votre téléphone. Aucun mot de passe requis.",
    },
    "de": {
        ...
        "wifiConnectSubtitle": "Tippen, um das Passwort zu kopieren",
        ...
        "wifiConnectHintOpen": "Verbinden Sie sich in den Telefoneinstellungen mit „{ssid}“. Kein Passwort erforderlich.",
    },
    "es": {
        ...
        "wifiConnectSubtitle": "Toca para copiar la contraseña",
        "wifiConnectHint": "<strong>Contraseña copiada.</strong> Abre <strong>Ajustes → Wi‑Fi</strong>, selecciona «{ssid}» y <strong>pega</strong>.",
        "wifiConnectHintOpen": "Conéctate a la red «{ssid}» desde los ajustes del teléfono. No se requiere contraseña.",
    },
}
